...
#             print("query_layer",query_layer[0,0])
#             print("key_layer",key_layer[0,0])
#             print("value_layer",value_layer[0,0])
#             return
        # ==================================
...
class ParallelTransformer(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask, layer_past=None,
                get_key_value=False):
#         if mpu.get_data_parallel_rank() == 0:
#             print("hidden_states[0,0]", hidden_states[0, 0, :768], hidden_states[0, 0, 768:])
#         return None
        # Checks
        if layer_past is not None:
...
#         if mpu.get_data_parallel_rank() == 0:
#             print("output[0,0]", output[0, 0, :768], output[0, 0, 768:])
#         return None        
