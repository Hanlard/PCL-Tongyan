...
# import deepspeed
import torch
from fairseq.model_parallel.megatron import fused_kernels
...
def _add_training_args(parser):
    ...
    group.add_argument('--Gradient_accumulation', type=int, default=1,
                       help='梯度累加，不开就是1')
    group.add_argument('--transfer', action='store_true', 
                       help='Use transfer')
    group.add_argument('--zero_ini', action='store_true', 
                       help='Use transfer')
    return parser
