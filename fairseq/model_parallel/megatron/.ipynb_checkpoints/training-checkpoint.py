...
from fairseq.model_parallel.megatron import get_timers
from fairseq.model_parallel.megatron import get_tensorboard_writer
from fairseq.model_parallel.megatron import mpu
from fairseq.model_parallel.megatron import print_rank_0
from fairseq.model_parallel.megatron.checkpointing import load_checkpoint
from fairseq.model_parallel.megatron.checkpointing import transfer_checkpoint
from fairseq.model_parallel.megatron.checkpointing import save_checkpoint
from fairseq.model_parallel.megatron.fp16 import FP16_Module
from fairseq.model_parallel.megatron.fp16 import FP16_Optimizer
from fairseq.model_parallel.megatron.initialize import initialize_megatron
from fairseq.model_parallel.megatron.learning_rates import AnnealingLR
from fairseq.model_parallel.megatron.model import DistributedDataParallel as LocalDDP
from fairseq.model_parallel.megatron.model import get_params_for_weight_decay_optimization
from fairseq.model_parallel.megatron.model.realm_model import ICTBertModel
from fairseq.model_parallel.megatron.utils import check_adlr_autoresume_termination
from fairseq.model_parallel.megatron.utils import make_data_loader
from fairseq.model_parallel.megatron.utils import report_memory
...
def setup_model_and_optimizer(model_provider_func):
    ...
    if args.transfer:
        if args.load is not None:
            args.iteration = transfer_checkpoint(model, optimizer, lr_scheduler)
            ## Here copy the new parameter from fp16 to fp32 again, which is used for parameters undating.  
            optimizer = get_optimizer(model)
            lr_scheduler = get_learning_rate_scheduler(optimizer)
    else:
        if args.load is not None:
...
def train_step(forward_step_func, data_iterator,
    ...
    if iteration % args.Gradient_accumulation == 0 and iteration>0:
        optimizer.step()
        optimizer.zero_grad(set_grads_to_None=True)#fp16
#         optimizer.zero_grad()#fp32
